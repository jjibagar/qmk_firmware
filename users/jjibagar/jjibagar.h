...
#define _____BASE_D3_____ DV_B, DV_M, DV_W, DV_V, RGUI_T(DV_Z), DV_QUOT,                 // KC_MINS,
...
#define _____ADJUST_D3_____ QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, JUEGOS, MACRO3,
...
#define _____EMACS_I2_____ TAB, IEDIT, OPEN, ACE_W, BUFFER, V0,
#define _____EMACS_I3_____ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KILL, EXPAND,
