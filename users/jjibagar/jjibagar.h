...
#define _____LOWER_I2_____ TD(CTRL_LP),TD(TD_LLAVE),  TD(ALT_HR),TD(CTRL_HR),TD(LSFT_HR),TD(TD_BIRG),
...
#define _____JUEGOS_D3_____ DV_B, DV_M, DV_W, DV_W, DV_Z, DV_QUOT, // KC_MINS,
