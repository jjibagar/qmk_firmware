...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LSFT_T(KC_CAPS),TD(TD_GUION),TD(TD_COPY),KC_C, KC_V, KC_B,             KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
  ...
  [_LOWER] = LAYOUT_split_3x6_4(
    _______,  DV_IQUE,  DV_QUES,  DV_IEXL,  DV_EXLM,   DV_PIPE,            TG(_RAISE),  KC_UP,  _______,  KC_P7, KC_P8,  KC_P9,
  ...
  [_ADJUST] = LAYOUT_split_3x6_4(
    KC_PWR,   RGB_SAI, RGB_HUI,  RGB_MOD,  RGB_VAI,   RGB_TOG,          XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  MACRO1,
    XXXXXXX,   RGB_SAD, RGB_HUD,  RGB_RMOD, RGB_VAD,   XXXXXXX,          XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  MACRO2,
